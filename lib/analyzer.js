...
//  3. Call Claude with a language-conditional schema — no translation field when
//     DeepL handled it, no pronunciation (IPA) ever, no romanization for Korean
//  4. Merge DeepL translation into result
//  5. Generate Korean romanization locally via Revised Romanization algorithm
export async function analyzeText(text, apiKey, deeplKey = null) {
  validateInput(text);
